...
const int leftLean                   = 6000;  // BiPed is pushed left by an external force
const int rightLean                  = -5000; // BiPed is pushed right by an external force
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
  ...
  if(AcX > leftLean)
    PlayFrames(numberOfFramesLeftLean, playbackDelayBalance);
  if(AcX < rightLean)
    PlayFrames(numberOfFramesRightLean, playbackDelayBalance);
delay(50);
 /* 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
  ...
  for (int framesRowNumber = 0; framesRowNumber < numberOfFrames; framesRowNumber++)
  {
    ...
    {   
        ...
        // This branch determines whether or not the robot's movement based on
        ...
        else if (numberOfFrames == numberOfFramesLeftLean)   value = framesLeftLean[framesRowNumber][servo];
        else if (numberOfFrames == numberOfFramesRightLean)  value = framesRightLean[framesRowNumber][servo];
